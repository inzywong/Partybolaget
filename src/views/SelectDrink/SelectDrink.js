      ...
      case 'LOADED':
        drinksList = this.state.drinks.map((drink) =>
          <div key={drink.id} className="drinkCard drinkList col-sm-2">
            ...
            <p>{drink.price} kr</p>
            <button drink_id={drink.id} drink_name={drink.name} drink_alcohol={drink.alcohol*100}
              drink_volume={drink.volume*1000} drink_price={drink.price} onClick={this.onAddClicked}
